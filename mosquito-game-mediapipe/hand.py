...
class Hand:
    def __init__(self):
        self.orig_image = image.load("Assets/hand-on-flat-surface-1632654.png", size=(HAND_SIZE, HAND_SIZE))
        self.hide_hand =image.load("Assets/hand-on-flat-surface-1632654.png", size=(0,0))
        self.image = self.orig_image.copy()
        self.image_smaller = image.load("Assets/hand_close-removebg-preview.png", size=(HAND_SIZE, HAND_SIZE))
